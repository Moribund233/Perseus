...
async def get_branches(repo_id: int, db: Session):
    """
    获取仓库的所有分支
...
async def get_branch(repo_id: int, branch_name: str, db: Session):
    """
    获取仓库的特定分支
...
async def get_branch_by_id(branch_id: int, db: Session):
    """
    根据ID获取分支
...
async def create_branch(repo_id: int, branch_data: dict, db: Session):
    """
    创建新分支
...
async def update_branch(repo_id: int, branch_name: str, branch_data: dict, db: Session):
    """
    更新分支信息
...
async def delete_branch(repo_id: int, branch_name: str, db: Session):
    """
    删除分支
...
async def set_default_branch(repo_id: int, branch_id: int, db: Session):
    """
    设置默认分支
...
async def protect_branch(repo_id: int, branch_name: str, protection_settings: dict, db: Session):
    """
    保护分支
...
async def unprotect_branch(repo_id: int, branch_name: str, db: Session):
    """
    取消分支保护
...
async def get_default_branch(repo_id: int, db: Session):
    """
    获取默认分支
...
async def check_branch_protection(repo_id: int, branch_name: str, db: Session):
    """
    检查分支保护状态
