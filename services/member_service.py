...
async def get_repository_members(repo_id: int, db: Session):
    """
    获取仓库的所有成员
...
async def get_repository_member(repo_id: int, user_id: int, db: Session):
    """
    获取仓库的特定成员
...
async def add_repository_member(repo_id: int, member_data: dict, db: Session):
    """
    添加仓库成员
...
async def update_repository_member(repo_id: int, user_id: int, member_data: dict, db: Session):
    """
    更新仓库成员信息
...
async def remove_repository_member(repo_id: int, user_id: int, db: Session):
    """
    删除仓库成员
...
async def update_member_role(repo_id: int, user_id: int, role: str, db: Session):
    """
    更新成员角色
...
async def get_user_repositories(user_id: int, db: Session):
    """
    获取用户参与的所有仓库
...
async def check_member_permission(repo_id: int, user_id: int, required_role: str, db: Session):
    """
    检查用户在仓库中的权限
...
async def activate_repository_member(repo_id: int, user_id: int, db: Session):
    """
    激活仓库成员
...
async def deactivate_repository_member(repo_id: int, user_id: int, db: Session):
    """
    停用仓库成员
