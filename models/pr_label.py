...
pr_label_association = Table(
    "pr_labels",
    Base.metadata,
    Column("pull_request_id", Integer, ForeignKey("pull_requests.id"), primary_key=True),
    Column("label_id", Integer, ForeignKey("pr_label_definitions.id"), primary_key=True),
)
